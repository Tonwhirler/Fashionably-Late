		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 panner4 = ( uv6 + mulTime37 * float2( 0.5,0.9 ));
					float2 panner5 = ( uv6 + mulTime37 * float2( 1.1,0.1 ));
					float lerpResult12 = lerp( 0 , ( tex2D( _MainTex, panner4 ).r * tex2D( _MainTex, panner5 ).g ) , tex2D( _MainTex, uv6 ).a);
					float3 ase_worldPos = i.ase_texcoord3.xyz;
					float4 appendResult32 = (float4(_LightColor0.r , _LightColor0.g , _LightColor0.b , saturate( ( _Opacity * ( lerpResult12 * ( distance( _WorldSpaceCameraPos , ase_worldPos ) / _Fadedistance ) * _InvFade ) ) )));
...
/*ASEBEGIN
Version=15001
1927;29;1906;1004;1827.918;309.3177;1;True;False
...
ASEEND*/
//CHKSM=3925EBAF23BE45782C89F02D9BA7DEF3CEB80EF2