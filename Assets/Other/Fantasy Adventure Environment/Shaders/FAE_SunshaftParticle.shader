		...
		SubShader
		{
			...
			Pass {
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float4 appendResult42 = (float4(( _LightColor0.rgb * (i.color).rgb ).x , ( _LightColor0.rgb * (i.color).rgb ).y , ( _LightColor0.rgb * (i.color).rgb ).z , saturate( ( _Opacity * ( temp_output_34_0 * ( temp_output_34_0 * ( distance( _WorldSpaceCameraPos , ase_worldPos ) / _Fadedistance ) ) * _InvFade ) ) )));
...
/*ASEBEGIN
Version=15001
1927;29;1906;1004;-1166.738;300.4025;1.082702;True;False
...
Node;AmplifyShaderEditor.SamplerNode;29;981.6983,174.1721;Float;True;Property;_Alpha;Alpha;1;0;Create;True;0;0;False;0;9afc9fffc8d5eb04fbf46f8da66a5439;9afc9fffc8d5eb04fbf46f8da66a5439;True;0;False;white;Auto;False;Object;-1;Auto;ProceduralTexture;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;41;2872.652,146.0635;Float;False;True;2;Float;ASEMaterialInspector;0;5;FAE/Sunshaft Particle;0b6a9f8b4f707c74ca64c0be8e590de0;0;0;;2;True;2;SrcAlpha;OneMinusSrcAlpha;0;One;Zero;False;True;Off;True;True;True;True;False;False;True;2;False;False;True;4;Queue=Transparent;IgnoreProjector=True;RenderType=Transparent;PreviewType=Plane;False;0;0;0;False;False;False;False;False;False;False;False;False;True;0;0;0;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=402B6461E83B748BD3BF1DF6B8E31B780F0C8BB7