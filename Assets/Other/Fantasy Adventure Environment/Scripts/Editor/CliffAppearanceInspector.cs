...
namespace FAE
{
    ...
    public class CliffAppearanceInspector : Editor
    {
        ...
        public SerializedProperty isCoverageSupported;
        ...
        private void DrawFields()
        {
            ...
            if (ca.isCoverageSupported)
            {
                EditorGUILayout.HelpBox("This feature is not supported on DirectX 9, which is your current target Graphics API \n", MessageType.Error);
                ca.useCoverageShader = false;
            }
            else
            {
                ...
                {
                    EditorGUILayout.HelpBox("Currently this feature requires you to have the PigmentMapGenerator script on your terrain.\n\nThis will be resolved in a future update.", MessageType.Info);
        ...
        private void DoHeader()
        {
            ...
            if (showHelp) EditorGUILayout.HelpBox("This script allows you to editor multiple materials that use the FAE/Cliff shader.", MessageType.Info);
